    ...
    <div className="w-full flex items-center justify-between px-6 py-4
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="text-right">
          <p className="font-semibold text-cyan-200">Dr. Anya Sharma</p>
          <p className="text-xs text-gray-400">Academic Head</p>
        </div>
        ...
        {/* LOGOUT */}
        <LogOut className="w-6 h-6 text-red-400 cursor-pointer hover:text-red-300" />
